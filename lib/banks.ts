...
export const BANKS: Bank[] = [
    ...
    { code: "revolut", name: "Revolut", color: "#0075EB", icon: "globe" },
    { code: "nomad", name: "Nomad", color: "#FDB913", icon: "globe" },
    { code: "wise", name: "Wise", color: "#9FE870", icon: "globe" },
    { code: "avenue", name: "Avenue", color: "#000000", icon: "trendingup" },
    { code: "pan", name: "Banco Pan", color: "#0095DA", icon: "creditcard" },
    { code: "agibank", name: "Agibank", color: "#364188", icon: "landmark" },
    { code: "bs2", name: "BS2", color: "#0047BB", icon: "landmark" },
    { code: "bmg", name: "Banco BMG", color: "#F68B1F", icon: "landmark" },
